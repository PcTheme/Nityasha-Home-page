...
!function(e, t) {
    ...
    return (()=>{
        ...
        var z, B, N, V, j, K, Y, H, G, X, U, W, Z, Q, J, $ = {
            autoSleep: 120,
            force3D: "auto",
            nullTargetWarn: 1,
            units: {
        ...
        , _e = Array.isArray, ye = /(?:-?\.?\d|\.)+/gi, be = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, xe = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Se = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Te = /[+-]=-?[.\d]+/, we = /[^,'"\[\]\s]+/gi, Me = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Ce = {}, Ee = {}, ke = function(e) {
            ...
            return Cn(e, t, i),
            e._initted ? !n && e._pt && !B && (e._dur && !1 !== e.vars.lazy || !e._dur && e.vars.lazy) && G !== an.frame ? (Le.push(e),
            e._lazy = [i, r],
            1) : void 0 : 1
        }, St = function e(t) {
            var n = t.parent;
            ...
            return N && !t && N.selector ? N.selector(e) : !ue(e) || n || !K && on() ? _e(e) ? qt(e, n) : Ot(e) ? Pt.call(e, 0) : e ? [e] : [] : Pt.call((t || Y).querySelectorAll(e), 0)
        }, It = function(e) {
        ...
        var bn = function(e) {
            ...
            n.render = function(e, t, n) {
                ...
                _ !== this._tTime || n || y) {
                    ...
                    t || e < 0 && !f || !_ && !f && m || (Gt(this, _ === m && e >= 0 ? "onComplete" : "onReverseComplete", !0),
            ...
            n.getChildren = function(e, t, n, r) {
                ...
                for (var i = [], a = this._first; a; )
                    a._start >= r && (a instanceof Rn ? t && i.push(a) : (n && i.push(a),
            ...
            n.getTweensOf = function(e, t) {
                for (var n, r = [], i = Ft(e), a = this._first, o = de(t); a; )
                    a instanceof Rn ? Qe(a._targets, i) && (o ? (!xn || a._initted && a._ts) && a.globalTime(0) <= t && a.globalTime(a.totalDuration()) > t : !t || a.isActive()) && r.push(a) : (n = a.getTweensOf(i, t)).length && r.push.apply(r, n),
                    a = a._next;
                return r
            }
            ,
            n.tweenTo = function(e, t) {
                t = t || {};
                var n, r = this, i = Et(r, e), a = t, o = a.startAt, s = a.onStart, l = a.onStartParams, u = a.immediateRender, c = Rn.to(r, nt({
                    ease: t.ease || "none",
                    lazy: !1,
                    immediateRender: !1,
                    time: i,
        ...
        var xn, Sn, Tn = function(e, t, n, r, i, a, o) {
            var s, l, u, c, d, h, v, p, f = new Hn(this._pt,e,t,0,1,Bn,null,i), m = 0, g = 0;
            for (f.b = n,
            f.e = r,
            n += "",
            ...
            ce(r) && (r = r(i || 0, e, a));
            var c, d = e[t], h = "get" !== n ? n : ce(d) ? l ? e[t.indexOf("set") || !ce(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](l) : e[t]() : d, v = ce(d) ? l ? qn : On : Pn;
            if (ue(r) && (~r.indexOf("random(") && (r = Kt(r)),
            "=" === r.charAt(1) && ((c = Ze(h, r) + (Rt(h) || 0)) || 0 === c) && (r = c)),
            !u || h !== r || Sn)
                return isNaN(h * r) || "" === r ? (!d && !(t in e) && De(t, r),
                Tn.call(this, e, t, h, r, v, s || $.stringFilter, l)) : (c = new Hn(this._pt,e,t,+h || 0,r - (h || 0),"boolean" == typeof d ? zn : Ln,0,v),
                l && (c.fp = l),
            ...
            if (Be[e] && !1 !== (o = new Be[e]).init(i, o.rawVars ? t[e] : function(e, t, n, r, i) {
                ...
                for (a in e)
                    o[a] = kn(e[a], i, t, n, r);
                return o
            }(t[e], r, i, a, n), n, r, a) && (n._pt = s = new Hn(n._pt,i,e,0,1,o.render,o,0,o.priority),
            n !== X))
            ...
            !F || E && !g.stagger) {
                ...
                x = D && pe(x) || x && !D,
                a = 0; a < R.length; a++) {
                    if (c = (l = R[a])._gsap || Ye(R)[a]._gsap,
                    t._ptLookup[a] = v = {},
                    ze[c.id] && Le.length && Je(),
                    p = O === R ? a : O.indexOf(l),
                    d && !1 !== (h = new d).init(l, f || i, t, p, O) && (t._pt = s = new Hn(t._pt,l,h.name,0,1,h.render,h,0,h.priority),
        ...
        Xe(Dn + ",id,stagger,delay,duration,paused,scrollTrigger", (function(e) {
            return An[e] = 1
        }
        ));
        var Rn = function(e) {
            ...
            return n.render = function(e, t, n) {
                ...
                if (p) {
                    if (m !== this._tTime || !e || n || !this._initted && this._tTime || this._startAt && this._zTime < 0 !== f) {
                        ...
                        Gt(this, "onUpdate")),
                        this._repeat && a !== s && this.vars.onRepeat && !t && this.parent && Gt(this, "onRepeat"),
                        m !== this._tDur && m || this._tTime !== m || (f && !this._onUpdate && dt(this, e, 0, !0),
                        (e || !p) && (m === this._tDur && this._ts > 0 || !m && this._ts < 0) && ut(this, 1),
                        t || f && !h || !(m || h || l) || (Gt(this, m === v ? "onComplete" : "onReverseComplete", !0),
                    ...
                    !function(e, t, n, r) {
                        ...
                        l !== s || B || r || e._zTime === ne || !t && e._zTime) {
                            ...
                            n || B || (Gt(e, l ? "onComplete" : "onReverseComplete", !0),
                            e._prom && e._prom()))
                        } else
                            e._zTime || (e._zTime = t)
                    }(this, e, t, n);
            ...
            n.kill = function(e, t) {
                ...
                !(e || t && "all" !== t))
                    ...
                    this.parent ? Xt(this) : this;
                if (this.timeline) {
                    var n = this.timeline.totalDuration();
                    return this.timeline.killTweensOf(e, t, xn && !0 !== xn.vars.overwrite)._first || Xt(this),
                ...
                t = s),
                t = function(e, t) {
                    var n, r, i, a, o = e[0] ? He(e[0]).harness : 0, s = o && o.aliases;
                    if (!s)
                        return t;
                    for (r in n = rt({}, t),
                    s)
                ...
                u = c.length; u--; )
                    if (~d.indexOf(c[u]))
                        ...
                        o)
                            ...
                            delete i[s]),
                            "all" !== a && (a[s] = 1);
                return this._initted && !this._pt && v && Xt(this),
                this
            }
            ,
            t.to = function(e, n) {
        ...
        Xe(Ke + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", (function(e) {
            return Ie[e] = 1
        }
        )),
        ...
        var Gn = []
          ...
          , $n = function() {
            ...
            t.getTweens = function() {
                ...
                return this.data.forEach((function(n) {
                    return n instanceof e ? t.push.apply(t, n.getTweens()) : n instanceof Rn && !(n.parent && "nested" === n.parent.data) && t.push(n)
                }
                )),
                t
            }
          ...
          , er = function() {
            ...
            return t.add = function(e, t, n) {
                ...
                o.queries = e,
                e)
                    "all" === i ? a = 1 : (r = j.matchMedia(e[i])) && (Gn.indexOf(o) < 0 && Gn.push(o),
                    (s[i] = r.matches) && (a = 1),
          ...
          , tr = {
            ...
            exportRoot: function(e, t) {
                ...
                n = V._first; n; )
                    r = n._next,
                    !t && !n._dur && n instanceof Rn && n.vars.onComplete === n._targets[0] || yt(i, n, n._start - n._delay),
                    n = r;
                return yt(V, i, 0),
                i
            },
        ...
        const pr = (e,t,i,a,{attributes: o, camera: s, renderer: l, width: u, height: c, scene: d, geometry: h, opts: v, effect: p=0}={})=>{
            ...
            ;
            v.preset && fetch(v.preset).then((e=>e.json())).then((e=>P(e))),
            v.config && P(v.config),
            v.debug && !vr[p] && (vr[p] = !0,
            A = new (F()),
            ...
            document.querySelector("body #controlKit .panel .button, #controlKit .picker .button").style.color = "#8c92a4",
            "img" !== e.nodeName.toLowerCase() && 1 != v.gooey && R.addSelect(D, "scrollType", {
                target: "scrollTypeIs",
                label: "Scroll Type",
        ...
        function Cr(e="img", t={}) {
            ...
            document.querySelectorAll(e).forEach((function(e) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    var {debugObj: l, panel: c, uniforms: h, animate: p} = pr(e, R(), O(), {
                        invert: {
                            value: !1
                        },
                        isTexture: {
